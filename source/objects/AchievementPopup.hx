...
class AchievementPopup extends FlxSpriteGroup {
	...
	public function new(name:String, ?camera:FlxCamera = null)
	{
		...
		var curAchievement:Achievement = Achievements.get(name);
		...
		var achievementName:FlxText = new FlxText(achievementIcon.x + achievementIcon.width + 20, achievementIcon.y + 16, 280, curAchievement.name, 16);
