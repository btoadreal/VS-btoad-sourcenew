...
class PauseSubState extends MusicBeatSubstate
{
	...
	public function new(x:Float, y:Float)
	{
		...
		var stupidAssImage:FlxSprite = new FlxSprite().loadGraphic(Paths.image("betoad"));
		stupidAssImage.setGraphicSize(Std.int(stupidAssImage.width * 0.25));
		stupidAssImage.updateHitbox();
		stupidAssImage.setPosition(FlxG.width - stupidAssImage.width, FlxG.height - stupidAssImage.height);
		add(stupidAssImage);
